...
// --- NEW: Importing the extracted UI components ---
...
export default function UmpireConsole({ matchData, onEndMatch }) {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-950 text-white select-none relative">
      ...
      <ExitModal isOpen={exitModalOpen} onClose={() => setExitModalOpen(false)} onConfirm={onEndMatch} />
      <ExtraModal extraModal={extraModal} setExtraModal={setExtraModal} confirmExtra={confirmExtra} />
      <WicketModal wicketModal={wicketModal} setWicketModal={setWicketModal} confirmWicket={confirmWicket} striker={striker} nonStriker={nonStriker} fieldingTeamList={fieldingTeamList} />
